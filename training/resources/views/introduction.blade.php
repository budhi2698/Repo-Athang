			...
			<div class="pd-ltr-20 xs-pd-20-10">
				<div class="min-height-200px">
						...
						<div class="row">
							...
							<div class="col-md-6 col-sm-12 text-right">
								<div class="dropdown">
									...
									<div class="dropdown-menu dropdown-menu-right">
										<a class="dropdown-item active" href="/introduction"
											>Introduction</a
										>
					...
					<div class="pd-20 card-box mb-30">
						...
						<p>
							Athang admin is only available for admin
							dashboards and control panels. Athang admin can manage
							varitey of pages and hencforth it is fully responsive HTML
							, which is based on the CSS framework Bootstrap 4. 
						</p>
						<p>
							We put a lot of love and effort to make Athang Admin a useful
							 for admin users and We are keen to
